...
<head>
  <meta charset="utf-8" />
  <title>Módulo de fondos de información</title>
  <meta name="description" content="app, web app, responsive, admin dashboard, admin, flat, flat ui, ui kit, off screen nav" />
  <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" /> 
  <?php include("referencias.php"); ?> 
  <script type="text/javascript" src="resources/fi.js"></script>
</head>
<body>
  <section class="vbox">
      ...
      <section class="hbox stretch">
       ...
       <div class="ex1">
          ...
          <section class="vbox">         
            ...
            <div class="row">
              <div class="col-md-6" style="margin-top: 30px; margin-left: 20px;">
                        <p class="robo" style="font-weight: 300; margin-bottom: 0px; font-size: 30px;">Fondo de información</p>
                        <p class="robo" style="font-weight: 300; font-size: 14px; height: 40px;">Gesti&oacute;n  de fondos para información</p>
              </div> 
          ...
          <div class="form-column col-md-11 col-sm-11 col-xs-11" style="margin-top: 1px;">
            <div class="btn-group pull-right">
                <a href="#" class="admin-menu-navi">
                    <button class="btn btn-primary  btn-sm " style="margin-left: 5px;" id="nuevaFI">Nuevo</button>
                 </a>
            </div>
        </div>
        ...
        <div class="clearfix"></div>   
              ...
              <table id="listadoFI" class="mdl-data-table" cellspacing="1" width="100%">
              <thead>
                <th>Color</th>
                <th>Imagen</th>
                <th>Acciones</th>
                  ...
                  if ($data!=false) {
                    ...
                    foreach ($data as $value) {
                      echo "<tr>
                          ...
                          <td>
                            <input type='button' class='btn-danger btn-sm eliminarFI' id='".$value['id']."' value='Eliminar'>
                          </td>
                      </tr>";
                    }
                  }
...
<div class="modal fade modal" id="modalIngresoFI" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header " Style="height:45px;">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Cerrar</span></button>
                    <span class="robo" style="font-size: 20px;">Agregar Fondo Información</span>
                </div>
                <div class="modal-body" >
                  <form method="POST" action="../controller/FondoIController.php" enctype="multipart/form-data">
                      <div class="row" id="infoFI">
                          <div class="form-column col-md-4 col-sm-4 col-xs-4">
                            <div class="form-group required">
                              <label for="nomColorFI" class="control-label">Nombre del color</label>            
                              <input type="text" name="nomColorFI" id="nomColorFI" placeholder="Nombre del color, ej: Naranja, azul, etc."  required>
                            </div>

                          </div>
                          <div class="form-column col-md-4 col-sm-4 col-xs-4">
                            <div class="form-group required">
                              <label for="imgFI" class="control-label">Imagen</label>            
                              <input type="file" name="imgFI" id="imgFI" required>
                            </div>
              ...
              <div class="clearfix"></div>
                    <div>
                    <button class="btn btn-primary  btn-sm " id="agregarFI" name="agregarFI">Guardar</button>
                  </div>     
