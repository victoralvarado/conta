$(document).ready(function(){
	...
	$(document).on("click","#nuevaDoc",function(){
		$("#modalIngresoDoc").modal({backdrop: 'static', keyboard: false});
	});


	$(document).on("click","#agregarDoc",function(){
		swal({
	        title: "Exito!",
                                ...
                                function (isConfirm) {
                                  if (isConfirm) {
                                    $.ajax({
                                          ...
                                          async: false,
                                          dataType: 'json',
                                          data: {idDoc:idDoc, key:'eliminarDoc'},
