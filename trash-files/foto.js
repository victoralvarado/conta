$(document).ready(function(){
	...
	$(document).on("click","#nuevaFoto",function(){
		$("#modalIngresoFoto").modal({backdrop: 'static', keyboard: false});
	});
	...
	$(document).on("click",".eliminarFoto",  function(){   
                                ...
                                function (isConfirm) {
                                  if (isConfirm) {
                                    $.ajax({
                                          ...
                                          async: false,
                                          dataType: 'json',
                                          data: {idFoto:idFoto, key:'eliminarFoto'},
