...
if (!isset($_POST['numProd'])) {
    ...
    $desde = '2021-06-07';
    $hasta = '2021-06-08';
    $descripcion = 'CUADERNO FERRARI 105MULTIMATERIAS180 HOJASD/O';
ob_start();
    ...
    <table style="width: 100%;" cellspacing="10">
        ...
        <?php
            ...
            <tr>
                ...
                <td style="border: black 2px solid;">
                    <?php echo mb_strtoupper($value['doc']); ?>
                </td>
                <td style="border: black 2px solid;">
                <?php echo $objP->mostrarClPr($value['tipo'],$value['cliente']); ?>
                </td>
                <td style="border: black 2px solid;">
                    <?php echo $tipo; ?>
                </td>
                ...
                <td style="border: black 2px solid;">
                <?php if ($tipo=='Venta') {
                        echo '$'.number_format($value['cantidad']*$value['precio'],2);
                    } ?>
                </td>
                <td style="border: black 2px solid;">
                    <?php 
