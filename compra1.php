                                    ...
                                    <div class=" col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group" style="text-align: center;">
                                                ...
                                                <button type="reset" class="btn btn-warning" id="reset" data-toggle="tooltip" data-placement="top" title="Limpiar cajas de texto"><em class="fa fa-eraser"></em> Limpiar</button>
                                            </div>
                                        </div>
                                </fieldset>
                            </form>
